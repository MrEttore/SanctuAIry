export const workload = {
    containers: [
        ...
        },
        {
            ...
            name: 'auth-service',
            image: 'sanctuairy/auth-service:v1.2.3',
            imageDigest:
        ...
        },
        {
            ...
            name: 'user-service',
            image: 'sanctuairy/user-service:v2.0.0',
            imageDigest:
        ...
        },
        {
            ...
            name: 'db-service',
            image: 'sanctuairy/db-service:5.7',
            imageDigest:
        ...
        },
        {
            ...
            name: 'cache-service',
            image: 'sanctuairy/cache-service:latest',
            imageDigest:
        ...
        },
        {
            ...
            name: 'worker-service',
            image: 'sanctuairy/worker-service:beta',
            imageDigest:
    ...
    images: [
        {
            ...
            repoDigests: [
                'sanctuairy/llm-core@sha256:f7360a64e62fa61d7688fe592f3d520a27317ed76adea9509d9e31ea83a4faac',
            ],
        ...
        },
        {
            ...
            repoTags: ['sanctuairy/auth-service:v1.2.3'],
            repoDigests: [
                'sanctuairy/auth-service@sha256:1111eeeebbccddff00112233445566778899aabbccddeeff',
            ],
        ...
        },
        {
            ...
            repoTags: ['sanctuairy/user-service:v2.0.0'],
            repoDigests: [
                'sanctuairy/user-service@sha256:2222fffdeeff2233445566778899aabbccddeeff00112233',
            ],
        ...
        },
        {
            ...
            repoTags: ['sanctuairy/db-service:5.7'],
            repoDigests: [
                'sanctuairy/db-service@sha256:3333abcddddeee11223344556677889900aabbccddeeff11',
            ],
        ...
        },
        {
            ...
            repoTags: ['sanctuairy/cache-service:latest'],
            repoDigests: [
                'sanctuairy/cache-service@sha256:4444bbbcccddd111122223333444455556666777788889999',
            ],
        ...
        },
        {
            ...
            repoTags: ['sanctuairy/worker-service:beta'],
            repoDigests: [
                'sanctuairy/worker-service@sha256:5555cccddd2222333344445555666677778888999900001111',
            ],
